#!/usr/bin/env bash
# Bump chatx5 version in version.properties, chatx5/_version.py, and Android Gradle.
set -euo pipefail
...
cat > "$ROOT/chatx5/_version.py" <<EOF
...
echo "  chatx5/_version.py -> server APP_VERSION"
