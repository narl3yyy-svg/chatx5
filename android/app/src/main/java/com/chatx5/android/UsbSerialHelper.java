...
public final class UsbSerialHelper {
    public static final String ACTION_USB_PERMISSION = "com.chatx5.android.USB_PERMISSION";

    private UsbSerialHelper() {}

    public static Context appContext() {
        Chatx5Application app = Chatx5Application.getInstance();
        if (app == null) {
            throw new IllegalStateException("Chatx5Application not initialized");
        }
