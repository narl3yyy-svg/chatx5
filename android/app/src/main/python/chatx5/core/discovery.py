...
from chatx5.core.rns_interfaces import configured_serial_enabled, load_settings_interfaces
...
class PeerDiscovery:
    ...
    def _on_announce(self, destination_hash, app_data, announced_identity=None):
        ...
        if not self._store_peer(peer):
            return
        try:
            from chatx5.core.peer_identity import register_identity_from_announce
    ...
    def _on_beacon(self, data, my_dest_hash, my_identity_hash=None, source_ip=None):
        ...
        if identity_hex and (identity_hex == my_ident or identity_hex == my_dest):
            return False
        try:
            from chatx5.core.peer_identity import peer_record_from_beacon
