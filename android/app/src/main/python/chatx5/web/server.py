...
class ChatWebServer:
    ...
    def _apply_lan_scope_change(self):
        ...
        from chatx5.core.lan_rns import clear_all_lan_paths, prune_known_udp_peer_ips
    ...
    def _resolve_peer_hash(self, peer_hash):
        from chatx5.core.discovery import normalize_hash, message_dest_hash_for_identity
        ...
        if hub_role == "server":
            ...
            for iface in interfaces:
                if iface.get("preset") == "tcp_server":
                    iface["enabled"] = False
            from chatx5.core.rns_interfaces import hub_tcp_client_active
    ...
    def _is_saved_contact(self, peer_hash):
        from chatx5.core.contacts import find_contact_by_hash
    ...
    def _on_peer_discovered(self, peer):
        ...
        from chatx5.core.contacts import sync_contact_from_discovery
