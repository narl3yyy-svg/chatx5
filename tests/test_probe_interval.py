...
class ProbeIntervalTests(unittest.TestCase):
    ...
    def test_peer_record_from_beacon_without_identity_registration(self):
        ...
        with patch("chatx5.core.peer_identity.register_beacon_identity", return_value=""):
    ...
    def test_probe_runs_despite_fresh_last_seen(self):
        ...
        with patch("chatx5.web.server.ChatWebServer._schedule_peers_broadcast"):
            with patch("chatx5.core.peer_probe.probe_udp_peer", return_value=12) as udp_probe:
