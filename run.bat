@echo off
REM Run chatx5 from this git clone folder in cmd. Ctrl+C stops everything.
...
set "CHATX5_MODULE=chatx5.app"
"%CHATX5_PYTHON%" -u -m %CHATX5_MODULE% %2 %3 %4 %5 %6 %7 %8 %9
